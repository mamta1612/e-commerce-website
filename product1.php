...
?>
    ...
    <div class="small-conatiner">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <img src="images/product1,12.jpg" alt="">
        ...
        <div class="row">
            <div class="col-4">
                <img src="images/product1,13.jpg" alt="">
                <h4>HunyHuny red color dress for girl</h4>
                <p>Rs.1299</p>
            </div>
            <div class="col-4">
                <img src="images/product1,14.jpg" alt="">
                <h4>HunnyHunny Hairbands For Baby Girl </h4>
                <p>Rs.599</p>
            </div>
            <div class="col-4">
                <img src="images/product1,15.jpg" alt="">
                <h4>H&M pinkish Fork For Girls </h4>
                <p>Rs.2299</p>
            </div>
            <div class="col-4">
                <img src="images/product1,16.jpg" alt="">
