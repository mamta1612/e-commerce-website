...
?>
    ...
    <div class="small-conatiner">
        ...
        <div class="row">
            <div class="col-4">
                <img src="images/dresss9.jpg" alt="">
                <h4>HunyHuny yellow blue tshirt pant </h4>
                <p>Rs.1299</p>
            </div>
            <div class="col-4">
                <img src="images/dresss10.jpg" alt="">
                <h4>H&M boy Suit with tie with white shoes </h4>
                <p>Rs.2299</p>
            </div>
            <div class="col-4">
                <img src="images/dresss11.jpg" alt="">
                <h4>ginimini Pinkish gown for baby girl</h4>
                <p>Rs.2499</p>
            </div>
            <div class="col-4">
                <img src="images/dresss12.jpg" alt="">
        ...
        <div class="row">
            <div class="col-4">
                <img src="images/dresss13.jpg" alt="">
                <h4>HunyHuny red color dress for girl</h4>
                <p>Rs.1299</p>
            </div>
            <div class="col-4">
                <img src="images/dresss14.jpg" alt="">
            ...
            <div class="col-4">
                <img src="images/product2.16.jpg" alt="">
